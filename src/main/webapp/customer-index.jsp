...
%>
    ...
    <section class="about py-5">
        <div class="container pb-lg-3">
            ...
            <div class="row">
            <%List<Selling> list = SellingDao.ProductList(); %>
            <%for(Selling s:list){ %>
                <div class="col-md-4 product-men">
                    <div class="product-shoe-info shoe text-center">
                        ...
                        <div class="item-info-product">
                            <h4>
                                <a href="shop-single.html"><%=s.getName() %> </a>
                            </h4>
                            <h4>
                                <a href="shop-single.html"><%=s.getCategory()%> </a>
                            </h4>
                            <div class="product_price">
                                <div class="grid-price">
                                    <span class="money"><%=s.getPrice()%></span>
                                </div>
                            </div>
                            <ul class="stars">
